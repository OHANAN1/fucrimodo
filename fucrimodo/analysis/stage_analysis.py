...
if __name__ == "__main__":
    ...
    print(get_stage_overview(stage_data))
    print()
    print("________________________________________________________")
    ...
    plot_fitness_statistics(stage_data, 0)
    plot_modification_statistics(stage_data, "Mutation", 0)
    plot_modification_statistics(stage_data, "Crossover", 0)
