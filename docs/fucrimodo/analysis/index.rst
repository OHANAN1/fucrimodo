...
The module :mod:`analysis.run_analysis` provides classes and methods to
analyse the data that was collected during a :class:`MultiStageSearch`
algorithm.

.. currentmodule:: fucrimodo.analysis
