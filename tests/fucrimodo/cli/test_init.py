...
def test_run_init(runner, tmp_path):
    ...
    assert (lab_path / "configs" / "analysis").exists()
    assert (lab_path / "configs" / "analysis" / "stage" / "default.py").exists()
    assert (lab_path / "configs" / "analysis" / "run" / "default.py").exists()
    assert (lab_path / "configs" / "analysis" / "multi_run" / "default.py").exists()
