...
if __name__ == "__main__":
    ...
    parser.add_argument("input_path", type=str, help="Path to input file. Must be readable by ASE.io.read.")
    parser.add_argument("output_path", type=str, help="Path to output file. Must be json-file.")
