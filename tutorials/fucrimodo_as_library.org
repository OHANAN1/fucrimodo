...
#+RESULTS:
: /tmp/fucrimodo_example_khw42las
...
: <fucrimodo.core.modules.population.Population at 0x7f596001b800>
:END:
...
#+RESULTS:
:RESULTS:
: Run notebook_example_run: Running stage: optimize_ga, ID: 2Run notebook_example_run: Finished stage: optimize_ga, ID: 2
: <fucrimodo.core.modules.population.Population at 0x7f596001b800>
:END:
** Analyse Run
...
#+RESULTS:
: /tmp/fucrimodo_example_khw42las/notebook_example_run
