...
from src.fucrimodo.crystal_creation import start_populations as cc_start_pop
from src.fucrimodo.crystal_creation import fitness_functions as cc_fit
from src.fucrimodo.crystal_creation import crossovers as cc_cross
from src.fucrimodo.crystal_creation import mutations as cc_mut
from src.fucrimodo.utils import debug_tools
from src.fucrimodo.crystal_creation import break_conditions as cc_break
import datetime
import os
import ase
...
from src.utils import verbose_print as vprint
import numpy as np
...
class StageData:
    ...
    def __init__(
        ...
        fitness_functions: list[cc_fit.FitnessFunction | tuple[cc_fit.FitnessFunction, float | int]] | list[cc_fit.FitnessFunction] | list[tuple[cc_fit.FitnessFunction, float | int]],  # noqa
        start_pop_generation: cc_start_pop.StartPopulation,
        mutation_probability: float,
        crossover_probability: float,
        crossover_list: list[cc_cross.Crossover | tuple[cc_cross.Crossover, float]],  # noqa
        mutation_list: list[cc_mut.Mutation | tuple[cc_mut.Mutation, float]],
        break_condition: cc_break.BreakCondition,
        additional_statistics_func: Callable[[ase.Atoms], float] | None = None,
        add_stats_func_name: str | None = None,
    ) -> None:
        self.start_pop_generation = start_pop_generation
    ...
    def get_params_dict(self) -> dict:
        ...
        params_dict = {
            ...
            "start pop generation": self.start_pop_generation,
...
class RunData:
    ...
    def add_run_settings(
        ...
        vprint.v0("Run settings added.", verbose)
